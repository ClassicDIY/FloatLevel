...
const  char Home_HTML[] PROGMEM =  R"rawliteral(
  ...
  <body>
	...
	<div> 
		<p><div class="pump"> Pump 1: <div id="pump1" class="pump">off</div> </div> </p>
		<p><div class="pump"> Pump 2: <div id="pump2" class="pump">off</div> </div> </p>
		<p><div class="pump"> Pump 3: <div id="pump3" class="pump">off</div> </div> </p>
		<p><div class="pump"> Pump 4: <div id="pump4" class="pump">off</div> </div> </p>
		
		<p> <a href="./settings">View Current Settings</a> </p>
		<p> <a href="./config">Modify Configuration</a> ><div class="pump">Log in with "admin", AP password (default is 12345678)</div></p>
			...
			if (window.WebSocket) {      
				console.log("WebSocket object is supported in your browser");
				  ...
				  socket.onmessage = function (e) {
					...
					var anem = eval('(' + e.data + ')');
					Gauge.Collection.get('CW_gauge').setValue(anem.level)
					document.getElementById("pump1").innerHTML=anem.pump1; 
					document.getElementById("pump2").innerHTML=anem.pump2; 
					document.getElementById("pump3").innerHTML=anem.pump3; 
					document.getElementById("pump4").innerHTML=anem.pump4; 
				  };
